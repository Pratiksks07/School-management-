...
class qbank_adm(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.add = tk.Button(self.top,command=lambda:self.add_ques())
        self.add.place(relx=0.100, rely=0.850, height=60, width=160)
        self.add.configure(activebackground="#f2f6fe")
        self.add.configure(activeforeground="black")
        self.add.configure(background="#f2f6fe")
        self.add.configure(disabledforeground="#a3a3a3")
        self.add.configure(font="-family {Segoe UI} -size 9")
        ...
        self.add.configure(text='''Back''')
        photo_location = os.path.join(_location,"../Image/Add_button.png")
        global _img5
        _img5 = tk.PhotoImage(file=photo_location)
        self.add.configure(image=_img5)
        self.add.configure(relief="flat")
    ...
    def add_ques(self):
        question = self.Text2.get("1.0", "end-1c")
        ques(question,cls,subj,chapter)
