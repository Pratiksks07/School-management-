...
class msg_adm(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Button1 = tk.Button(self.top,command=lambda:sent(self))
        ...
        #_style_code()
        self.TCombobox1 = ttk.Combobox(self.top,values=['Self','Students'],textvariable=category)
        ...
        self.Button3 = tk.Button(self.top,command=lambda:self.admin(controller))
    ...
    def display_table(self,cat):
        ...
        columns, rows = fetch_data_admin(type=cat)
